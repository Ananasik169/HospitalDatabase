...
class JWTAuthentication(authentication.BaseAuthentication):
    ...
    def authenticate(self, request):
        ...
        возвращаемых значения:
            1) None - возвращаем None если не хотим аутентифицироваться.
            2) (user, token) - возвращаем комбинацию пользователь/токен
            тогда, когда аутентификация пройдена успешно.
        """
        request.user = None

        # 'auth_header' должен быть массивом с двумя элементами:
        # 1) именем заголовок аутентификации (Token в нашем случае)
